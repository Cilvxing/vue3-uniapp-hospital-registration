  ...
  setup(__props) {
    ...
    common_vendor.onShow(async () => {
      common_vendor.index.request({
        url: "http://localhost:3000/user_registrat",
        data: {},
        success: (res2) => {
          console.log("\u9884\u7EA6\u8BE6\u60C5", res2);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/WeChatProject/Medical/src/pages/my-service/my-registration/index.vue"]]);
