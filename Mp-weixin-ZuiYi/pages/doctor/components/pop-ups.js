  ...
  setup(__props, { expose }) {
    ...
    async function subMit() {
      ...
      common_vendor.index.request({
        url: "http://localhost:3000/regappoin",
        data: {
          submitData
        },
        success: (res2) => {
          console.log("\u9884\u7EA6\u63D0\u4EA4", res2);
        }
      });
      {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-01fb815f"], ["__file", "D:/WeChatProject/Medical/src/pages/doctor/components/pop-ups.vue"]]);
