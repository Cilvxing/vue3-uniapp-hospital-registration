...
CREATE TABLE `order_` (
  ...
  `dep_ment` varchar(45) DEFAULT NULL,
  `que_number` varchar(45) DEFAULT NULL,
  `reg_cost` varchar(45) DEFAULT NULL,
...
INSERT INTO `order_` VALUES ('s123456gdxnsl',0,'心内管内科','10','50','1号门诊楼4层心血管内科1号诊室','07-20','刘西平','07-17','小王');
